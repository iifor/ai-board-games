...
const { cachedLlmCall } = require('../llm');
const { callOpenAIChat } = require('../llm');
const { DEBATE, PHASES } = require('./constants');
...
function buildSystemPrompt(agent, topic, phase = PHASES[0]) {
...
module.exports = { getDebateRoleName, buildSystemPrompt, buildHostPrompt, askHost };
