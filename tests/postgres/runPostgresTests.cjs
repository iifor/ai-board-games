...
const testFiles = ['dbExecutor.test.ts', 'schemaMigration.test.ts', 'coreRepositories.test.ts', 'gameRepositories.test.ts', 'workflowConcurrency.test.ts', 'sqliteImporter.test.ts']
