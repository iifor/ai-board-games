...
const conditionSchema: z.ZodType = z.lazy(() => z.union([
  z.boolean(),
  z.object({
...
const stepBlockerSchema = z.object({
  id: z.string().min(1),
  type: z.enum(Object.values(BLOCKER_TYPES) as [string, ...string[]]),
  required: z.boolean().default(true),
  status: z.enum(Object.values(BLOCKER_STATUS) as [string, ...string[]]),
...
const gameEventSchema = z.object({
  ...
  visibility: z.enum(Object.values(EVENT_VISIBILITY) as [string, ...string[]]).default(EVENT_VISIBILITY.PUBLIC),
...
const aiTaskSchema = z.object({
  ...
  playerId: z.union([z.string(), z.number()]).optional(),
  status: z.enum(Object.values(AI_TASK_STATUS) as [string, ...string[]]),
...
const pendingActionSchema = z.object({
  ...
  status: z.enum(Object.values(PENDING_ACTION_STATUS) as [string, ...string[]])
});
