...
export function PlayerWerewolfView(props: WerewolfGameArenaProps) {
  ...
  const rosterProps = { interaction, speakerId: props.currentSpeakerId, sheriffId, candidateIds, revealRoles: false, viewerPlayerId: props.visibleRolePlayerId, onSelect: props.onPlayerSelect };
