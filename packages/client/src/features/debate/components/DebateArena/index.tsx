...
interface DebateArenaProps {
  ...
  activeSpeech?: { playerId: string | null; text: string } | null;
...
export function DebateArena({ game, currentSpeakerId, currentPhase, streamMessage, subtitleSpeech, onPlayerSelect, isIdle, showPlayerPoster = false }: DebateArenaProps) {
  ...
  const mvpVoteTargets = useMemo(() => currentPhase?.id === 'mvp' ? getMvpVoteTargetMap(game) : new Map<number, string>(), [game, currentPhase]);
